...
tags:
  - "clippings"
---
## [Level Up Coding](https://medium.com/gitconnected?source=post_page---publication_nav-5517fd7b58a6-9d864966db07---------------------------------------)

![](_resources/580bc69f6f29b42d5c110e6d82437744_MD5.webp)
...
If you haven’t already, I recommend checking out my previous article: [Writing Interpreter in Rust — Repl, Files, and Comments (Part 4)](https://medium.com/better-programming/writing-interpreter-in-rust-repl-files-and-comments-part-4-5a11d41613ba)
...
`;` —Termination token (same as in any C-like language).
...
It will also allow us to extend it in the future when we deal with functions, closures and different scopes.

With the scope in place, we can evaluate source code line by line and declare, assign and reassign variables.
...
And of course, let’s not forget about tests!
...
Full source code can be found here:## [blog/src/writing-interpreter-with-rust-part-5-variables/coconut at main · Pavel-Durov/blog](https://github.com/Pavel-Durov/blog/tree/main/src/writing-interpreter-with-rust-part-5-variables/coconut?source=post_page-----9d864966db07---------------------------------------)

Blog articles and posts. Contribute to Pavel-Durov/blog development by creating an account on GitHub.

github.com

[View original](https://github.com/Pavel-Durov/blog/tree/main/src/writing-interpreter-with-rust-part-5-variables/coconut?source=post_page-----9d864966db07---------------------------------------)
...
While much of the heavy lifting was handled by the `grmtools` Parser, the rest of the implementation followed a straightforward path.
...
## More from Pavel Durov and Level Up Coding
...
](https://medium.com/?source=post_page---read_next_recirc--9d864966db07---------------------------------------)