...
tags:
  - "clippings"
---
Language : English | [Français](https://github.com/jbdoderlein/BetterOCaml/tree/master/lang/french#betterocaml)
...
The IDE is hosted [here](https://jbdoderlein.github.io/BetterOCaml), [https://jbdoderlein.github.io/BetterOCaml](https://jbdoderlein.github.io/BetterOCaml), but you can host your own version by simply copying the files from the `src/` directory on your host (on a folder of your laptop, or a folder of your web-server, see [http://ocaml.besson.link/](http://ocaml.besson.link/) for an example).
...
If you have any suggestion for a new theme, [open an issue](https://github.com/jbdoderlein/BetterOCaml/issues/new) 👍 !

## ✨ Use offline?

### 💻 On a laptop or desktop

- If you visit [the editor](https://jbdoderlein.github.io/BetterOCaml) webpage using your favorite browser, and if it works fine, you can add the link to your ⭐ "favorites", and then later on, if you open the direct link, it should work and load back BetterOCaml... even if your browser is offline!
...
- Loading the OCaml toplevel can take a few seconds on a mobile 3G/4G or 🐌 slow Wifi networks: it's over 30 Mb, as it includes all of [OCaml standard library](https://caml.inria.fr/pub/docs/manual-ocaml/libref/)!
...
- If you think that this is not enough, and that the website should be bundled as a native iOS/Android app, please vote 👍 on [this issue](https://github.com/jbdoderlein/BetterOCaml/issues/14).
...
[https://jbdoderlein.github.io/BetterOCaml](https://jbdoderlein.github.io/BetterOCaml) offers `5.3.0`, and `4.14.1`
...
⚠️ **The web server hosting the file must allow [CORS](https://developer.mozilla.org/docs/Glossary/CORS)**.  
...
- [js\_of\_ocaml](https://ocsigen.org/js_of_ocaml/3.7.0/manual/overview) v3.7.0 : compile the OCaml toplevel to javascript;
