...
Fortsetzung von [[docs/11-kvm-windows11-vm]] und [[docs/12-dateifreigabe-host-gast]].
...
| Homebrew | Möglich (`brew install freerdp`), aber FreeRDP ist **kein blattständiges Tool** — es will Audio (PipeWire), USB, Zwischenablage, Wayland. Verstößt gegen die Zwei-Schichten-Regel aus [[docs/13-xps13-wsl-installation]]. |
...
[[docs/12-dateifreigabe-host-gast]]:
...
mit intakter TPM und BitLocker ([[docs/11-kvm-windows11-vm]]). WinBoat würde
...
- **Windows-Programme per WSL** — auf dem XPS ist WSL die
  Scout-Umgebung ([[docs/13-xps13-wsl-installation]]), nicht der
...
- [[docs/11-kvm-windows11-vm]] — die VM, auf der Weg A aufsetzt
- [[docs/12-dateifreigabe-host-gast]] — virtiofs, Gegenstück zu `\\tsclient\home`
